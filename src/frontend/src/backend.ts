...
export class Backend implements backendInterface {
    ...
    async getFees(): Promise<Array<RegistrationFee>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFees();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSchedule(): Promise<Array<ScheduleItem>> {
        if (this.processError) {
            try {
    ...
    async getSpeakers(): Promise<Array<Speaker>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSpeakers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
